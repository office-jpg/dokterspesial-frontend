...
import { DD_TECHNIQUES } from "~/contents/dd";

function DDSectionComponent() {
            ...
            <MaxWidthWrapper>
                <div className="mb-10 flex flex-col items-center justify-start gap-0 md:mb-0 md:flex-row md:gap-12">
                    <SectionHeader
                        ...
                        subtitle="Dokter Dentist adalah brand kedokteran gigi yang fokus meningkatkan keterampilan dokter gigi melalui webinar, workshop, dan program edukasi berbasis praktik"
                    />
                    <motion.img
                        src="/brand/dd.webp"
                ...
                >
                    <div className="bg-secondary/80 border-secondary inline-flex items-center gap-3 border px-6 py-3">
                        ...
                        <p className="text-foreground text-sm font-medium md:text-base">
                            Seluruh program DD diselenggarakan dan didukung
                            penuh oleh{" "}
                ...
                <div className="relative mt-10">
                    ...
                    >
                        {DD_TECHNIQUES.map((technique, index) => {
...
export const DDSection = memo(DDSectionComponent);
